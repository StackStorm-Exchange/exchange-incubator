...
class MQTTSensor(Sensor):
    def __init__(self, sensor_service, config=None):
        ...
        self._trigger = 'monitor_mqtt.message'
    ...
    def setup(self):
        ...
        self._logger.warn("hostname:::" + self._hostname)
        self._logger.warn("_client_id:::" + self._client_id)
        self._logger.warn("_userdata:::" + self._userdata)
        self._logger.warn("_protocol:::" + self._protocol)
